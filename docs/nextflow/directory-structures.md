...
| `validated_params.json`    | JSON file produced by the validation step; loaded by Nextflow via `-params-file`. Contains validated FASTA paths and the `fasta_ref_x_mod` flag. |
