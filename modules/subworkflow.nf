...
include { convert_bcf_to_vcf; delly; samtools_index; picard_dict; sniffles; debreak; cute_sv; survivor; vcf_to_table as vcftable_short; vcf_to_table as vcftable_long } from '../modules/sv_calling.nf'
