...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python main_eukaryote.py <config_path>")
        print("\nExample:")
        print("  python main_eukaryote.py config.json")
        return 1

    # Setup logging,
    setup_logging(console_level='DEBUG',log_file=Path("/EFSA_workspace/data/valid/logs/validation_eukaryote.log"))
    ...
    # ========================================================================
    report = ValidationReport(Path("/EFSA_workspace/data/valid/logs/report_eukaryote.txt"))
